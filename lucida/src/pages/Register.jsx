...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    localStorage.setItem('lucida-user', JSON.stringify({ name: formData.name, email: formData.email }));
    navigate('/dashboard');
  };
    ...
    <div className="min-h-screen w-full bg-[#05060f] flex items-center justify-center relative overflow-hidden font-inter">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-white/50 mt-2 text-sm">Join Lucida and start reading better</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 text-white/30 group-focus-within:text-purple-400 transition-colors" size={18} />
                <input
                  required
                  type="text"
                  name="name"
            ...
            <Button type="submit" className="w-full py-3.5 group mt-4">
              Create Account
